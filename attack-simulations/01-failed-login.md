...
The event details were examined to identify the affected account, logon type, timestamp, and failure reason. These fields were used to validate the activity and correlate it with SIEM telemetry.
...
5. Apply least privilege principles to reduce the impact of compromised accounts.
